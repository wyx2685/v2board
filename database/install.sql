...
CREATE TABLE `v2_server_tuic` (
                                      ...
                                      `insecure` varchar(16) NOT NULL DEFAULT '0' COMMENT 'TLS 验证模式：0、pincert 或 1',
                                      `pinned_peer_cert_sha256` varchar(95) DEFAULT NULL COMMENT '完整证书 SHA-256（十六进制）',
                                      `certificate_public_key_sha256` varchar(128) DEFAULT NULL COMMENT 'SPKI SHA-256（Base64，sing-box）',
...
CREATE TABLE `v2_server_trojan` (
                                    ...
                                    `allow_insecure` varchar(16) NOT NULL DEFAULT '0' COMMENT 'TLS 验证模式：0、pincert 或 1',
                                    `pinned_peer_cert_sha256` varchar(95) DEFAULT NULL COMMENT '完整证书 SHA-256（十六进制）',
                                    `certificate_public_key_sha256` varchar(128) DEFAULT NULL COMMENT 'SPKI SHA-256（Base64，sing-box）',
