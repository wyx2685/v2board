window.settings.i18n['zh-CN'] = {
  ...
  '确定要解除绑定Telegram？': '确定要解除绑定 Telegram？',
  '如果你的Telegram ID已失效可以进行此操作。重置后你需要重新进行绑定。': '如果你的 Telegram ID 已失效，可以进行此操作。重置后需要重新绑定。',
  '请输入充值金额': '请输入充值金额',
  '解除绑定': '解除绑定',
  ...
  '充值奖励': '充值奖励',
  '实际到账': '实际到账',
  '确定开启下一个流量周期？': '确定开启下一个流量周期？',
  '点击「确定」将会扣除当前流量周期剩余订阅时长（按月重置时扣除本周期剩余订阅时长，每月1号重置时扣除整月时间30天，年周期同理），系统将会重置您的已使用流量。': '点击「确定」将扣除当前流量周期剩余的订阅时长（按月重置时扣除本周期剩余时长，每月 1 日重置时扣除整月 30 天，年周期同理），随后系统会重置已使用流量。',
  '购买流量重置包': '购买流量重置包',
  '提前开启流量周期': '提前开启流量周期',
  '已答复': '已答复',
  '待处理': '待处理'
